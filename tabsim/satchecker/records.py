...
stops (see :mod:`tabsim.satchecker.client` for the handover date), so tabsim
...
There is a third loss too — :func:`tabsim.satchecker.tle_parse.tle_epoch_jd`
...
:func:`~tabsim.satchecker.tle_parse.validate_elements` range and finiteness
