...
One parser, two consumers: :mod:`tabsim.orbit` derives OMM-style orbital
elements through it, and :mod:`tabsim.satchecker.cache` validates envelopes
...
def validate_elements(elements: dict, context: str = "orbital element set") -> None:
    ...
    trajectory. See :mod:`tabsim.satchecker.records` for what else is done to
    narrow that gap.
