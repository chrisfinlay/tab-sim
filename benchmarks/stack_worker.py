...
p=argparse.ArgumentParser();p.add_argument('--root');p.add_argument('--output');p.add_argument('--chunk',type=float,default=45);p.add_argument('--working',type=float);p.add_argument('--device',default='cpu');a=p.parse_args()
